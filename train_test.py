...
if __name__ == '__main__':
  ...
  parser.add_argument('--num_epochs', help='Number of epoch', default= 10, type=int)
  parser.add_argument('--modelnetwork','--modelnetwork',help='type of neural network', default="AlexNet", type=str, choices=['AlexNet','ResNet'])
